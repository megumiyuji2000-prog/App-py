...
.block-container {{padding-top: 1rem; padding-bottom: 140px; max-width: 720px}}
...
/* SEMBUNYIIN INPUT DEFAULT STREAMLIT */
.stChatInput, [data-testid="stChatInput"] {{display: none!important}}
...
# INPUT BAR CUSTOM - PAKE st.form BIAR + DAN 🎤 DI DALEM
with st.container():
    with st.form("input_form", clear_on_submit=True):
        ...
        with col2:
            ...
            st.markdown('<button style="background:transparent;border:1px solid '+BORDER+';border-radius:50%;width:36px;height:36px;color:'+TEKS+';">🎤</button>', unsafe_allow_html=True)
        with col3:
