...
if"trigger_upload"not in st.session_state:st.session_state.trigger_upload=False
if"trigger_mic"not in st.session_state:st.session_state.trigger_mic=False
GEMINI_LIMIT=35
GROQ_LIMIT=35
